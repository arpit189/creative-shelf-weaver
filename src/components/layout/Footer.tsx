        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              The portfolio platform for creative professionals to showcase their best work and build an engaging online presence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://blog.projectshelf.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Blog</a></li>
            </ul>
          </div>
